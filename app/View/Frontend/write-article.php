<section class="max-w-4xl mx-auto p-12 shadow-xl rounded">
  <h1 class="text-4xl font-medium mt-4 mb-12 text-center">Write new Article that is gonna be revolutionnary</h1>
  <form method="POST" action="/add-new-post" enctype="multipart/form-data">
    ...
    <input class="mt-4 cursor-pointer whitespace-nowrap inline-flex items-center justify-center px-16 py-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-amber-600 hover:bg-amber-700" type="submit" value="Create a Post"></input>
  </form>
</section>
