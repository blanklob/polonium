    ...
    <header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                ...
                <a href="#" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-amber-600 hover:bg-amber-700">
                    Sign up
                </a>
            </div>
            </div>
